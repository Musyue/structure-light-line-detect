...
class StruLight:
    def __init__(self,u0,v0,pu,pv,f,alpha,x4_laser_ref,y4_laser_ref,z4_laser_ref,T1,urdfname,calibinfo,lamda=4,):
        self.u0=u0
        self.v0=v0
        self.f=f
        self.pu=pu
    ...
    def transl(self,T):
        ...
        l = l1[c]
        return l
    def Get_vxvyvzwxwywz(self,theta_uv,theta_uv_desire,puv,puv_desire,T_reflection_to_camera,T_camera_to_endeffector):
    ...
    while not rospy.is_shutdown():
        if len(struct_uv_sub.left_uv0_buf)!=0 and len(struct_uv_sub.left_uv1_buf)!=0 and len(struct_uv_sub.right_uv0_buf)!=0 and len(struct_uv_sub.right_uv1_buf)!=0:
            ...
            if len(q_now)!=0:
                ...
                print "q_now\n", q_now
                #2,get ee_speed
                ee_speed=s0.Get_vxvyvzwxwywz(theta_uv,theta_uv_desire,puv,puv_desire,T_reflection_to_camera,T_camera_to_endeffector)
                #3,get  joint speed
